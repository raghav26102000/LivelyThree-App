...
class WeeklyselectedWaterTable extends SupabaseTable<WeeklyselectedWaterRow> {
  @override
  String get tableName => 'weeklyselected_water';

  @override
  WeeklyselectedWaterRow createRow(Map<String, dynamic> data) =>
      WeeklyselectedWaterRow(data);
}

class WeeklyselectedWaterRow extends SupabaseDataRow {
  WeeklyselectedWaterRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => WeeklyselectedWaterTable();
