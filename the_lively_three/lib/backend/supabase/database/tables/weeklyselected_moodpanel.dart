...
class WeeklyselectedMoodpanelTable
    extends SupabaseTable<WeeklyselectedMoodpanelRow> {
  @override
  String get tableName => 'weeklyselected_moodpanel';

  @override
  WeeklyselectedMoodpanelRow createRow(Map<String, dynamic> data) =>
      WeeklyselectedMoodpanelRow(data);
}

class WeeklyselectedMoodpanelRow extends SupabaseDataRow {
  WeeklyselectedMoodpanelRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => WeeklyselectedMoodpanelTable();
