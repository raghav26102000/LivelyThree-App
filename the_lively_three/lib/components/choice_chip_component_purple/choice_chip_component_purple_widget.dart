...
import 'choice_chip_component_purple_model.dart';
export 'choice_chip_component_purple_model.dart';

class ChoiceChipComponentPurpleWidget extends StatefulWidget {
  const ChoiceChipComponentPurpleWidget({
    super.key,
  ...
  @override
  State<ChoiceChipComponentPurpleWidget> createState() =>
      _ChoiceChipComponentPurpleWidgetState();
}

class _ChoiceChipComponentPurpleWidgetState
    extends State<ChoiceChipComponentPurpleWidget> {
  late ChoiceChipComponentPurpleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChoiceChipComponentPurpleModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FlutterFlowChoiceChips(
      ...
      onChanged: (val) async {
        safeSetState(() => _model.purpleChoiceChipsValues = val);
        FFAppState().totalWeeklySelectedPlants = functions.totalSelectNumber(
            ...
            _model.purpleChoiceChipsValues?.length,
        ...
        await widget.updateChoiceChipsAction?.call(
          _model.purpleChoiceChipsValues!,
        );
      },
      ...
      rowSpacing: 8.0,
      multiselect: true,
      initialized: _model.purpleChoiceChipsValues != null,
      alignment: WrapAlignment.start,
      controller: _model.purpleChoiceChipsValueController ??=
