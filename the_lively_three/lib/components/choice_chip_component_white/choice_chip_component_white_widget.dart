...
import 'choice_chip_component_white_model.dart';
export 'choice_chip_component_white_model.dart';

class ChoiceChipComponentWhiteWidget extends StatefulWidget {
  const ChoiceChipComponentWhiteWidget({
    super.key,
  ...
  @override
  State<ChoiceChipComponentWhiteWidget> createState() =>
      _ChoiceChipComponentWhiteWidgetState();
}

class _ChoiceChipComponentWhiteWidgetState
    extends State<ChoiceChipComponentWhiteWidget> {
  late ChoiceChipComponentWhiteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChoiceChipComponentWhiteModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FlutterFlowChoiceChips(
      ...
      onChanged: (val) async {
        safeSetState(() => _model.whiteChoiceChipsValues = val);
      ...
      rowSpacing: 8.0,
      multiselect: true,
      initialized: _model.whiteChoiceChipsValues != null,
      alignment: WrapAlignment.start,
      controller: _model.whiteChoiceChipsValueController ??=
