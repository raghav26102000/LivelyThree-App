...
import 'choice_chip_component_green_model.dart';
export 'choice_chip_component_green_model.dart';

class ChoiceChipComponentGreenWidget extends StatefulWidget {
  const ChoiceChipComponentGreenWidget({
    super.key,
  ...
  @override
  State<ChoiceChipComponentGreenWidget> createState() =>
      _ChoiceChipComponentGreenWidgetState();
}

class _ChoiceChipComponentGreenWidgetState
    extends State<ChoiceChipComponentGreenWidget> {
  late ChoiceChipComponentGreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChoiceChipComponentGreenModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FlutterFlowChoiceChips(
      ...
      onChanged: (val) async {
        safeSetState(() => _model.greenChoiceChipsValues = val);
        FFAppState().totalWeeklySelectedPlants = functions.totalSelectNumber(
            ...
            _model.greenChoiceChipsValues?.length,
      ...
      rowSpacing: 8.0,
      multiselect: true,
      initialized: _model.greenChoiceChipsValues != null,
      alignment: WrapAlignment.start,
      controller: _model.greenChoiceChipsValueController ??=
