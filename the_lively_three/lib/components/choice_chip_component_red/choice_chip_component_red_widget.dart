...
import 'choice_chip_component_red_model.dart';
export 'choice_chip_component_red_model.dart';

class ChoiceChipComponentRedWidget extends StatefulWidget {
  const ChoiceChipComponentRedWidget({
    super.key,
  ...
  @override
  State<ChoiceChipComponentRedWidget> createState() =>
      _ChoiceChipComponentRedWidgetState();
}

class _ChoiceChipComponentRedWidgetState
    extends State<ChoiceChipComponentRedWidget> {
  late ChoiceChipComponentRedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChoiceChipComponentRedModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FlutterFlowChoiceChips(
      ...
      onChanged: (val) async {
        safeSetState(() => _model.redChoiceChipsValues = val);
        FFAppState().redWeeklySelectedPlants =
            _model.redChoiceChipsValues!.length;
      ...
      rowSpacing: 8.0,
      multiselect: true,
      initialized: _model.redChoiceChipsValues != null,
      alignment: WrapAlignment.start,
      controller: _model.redChoiceChipsValueController ??=
