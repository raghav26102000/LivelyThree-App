...
Future<int?> decrementWeeklySelectedUPF(
  String userId,
  int calendarWeek,
  int calendarYear,
) async {
  ...
  try {
    ...
    if (response == null) {
      ...
      await supabase.from('weeklyselected_upf').insert(newRow);
    ...
    print('Error in decrementWeeklySelectedUPF: $e');
    return null;
  }
}
