...
Future<void> getNutrientBoundsWeeklySelection(
    int idLoc, String idUser, int week, int year) async {
  // Validate inputs.
  if (idLoc <= 0 || idUser.isEmpty || week <= 0 || year <= 0) {
    throw ArgumentError(
        "Invalid input: idLoc, idUser, week, and year must be provided.");
  }
